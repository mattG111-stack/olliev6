...
COLUMNS: list[tuple[str, str]] = [
    ...
    # What WE watched, next to what the file claimed. Two columns rather than
    # one because they answer different questions and can legitimately differ:
    # the file's figure is the portal's, ours is the gap between the week the
    # listing first reached us and the day its advertisement stopped answering.
    # Side by side they audit each other.
    ("First seen by us", "first_seen_at"),
    ("Days advertised", "days_advertised"),
...
_MONEY = {"asking_price", "cv_numeric", "land_value_numeric",
          ...
          "annual_cashflow"}
_DATES = {"link_checked_at", "link_dead_at", "first_seen_at"}
