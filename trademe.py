...
# The address key lives in app.addresses now — app.prior_price needs the same
# one, and importing THIS module from there would close a cycle
# (prior_price -> trademe -> ingest -> pipeline -> prior_price). Re-exported
# so every existing caller keeps working unchanged.
from .addresses import (STREET_TYPES as _STREET_TYPES, address_key,
                        expand_street_type as _expand_street_type)
