...
from portals import harvest as H
from portals.harvest import Harvest, HarvestCache
from portals.sources import (
    ACTORS,
    HAS_ESTIMATE,
    _PORTALS,
    _oneroof_result,
...
def test_a_property_with_no_suburb_is_not_guessed_at():
    ...
    from portals.sources import oneroof
...
def test_a_floor_area_with_a_unit_is_not_multiplied_by_ten():
    ...
    """
    from portals.legacy_fields import num
...
def test_an_abbreviated_street_type_matches_the_written_out_one():
    ...
    from trademe import address_key as k
