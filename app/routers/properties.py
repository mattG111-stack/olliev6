...
class ForSaleRow(BaseModel):
    ...
    oneroof_valuation: float | None = None
    oneroof_valuation_low: float | None = None
    oneroof_valuation_high: float | None = None
    oneroof_url: str | None = None

    # === "Trade Me says" — for display only, never an input (see app/trademe.py) ===
    tm_valuation: float | None = None
    tm_valuation_low: float | None = None
    tm_valuation_high: float | None = None
    tm_valuation_date: str | None = None
