...
def _sold_trend_json(db: Session, suburb: str, region: str) -> tuple[str | None, str | None]:
    ...
    def _series(buckets: dict, key_name: str, change_key: str) -> str | None:
        pts = []
        prev = None
...
def suburb_trend(
    ...
    source = "sold" if (sold_yearly or sold_monthly) else (
        "portal" if (lt_yearly or lt_monthly) else None)
