...
and matching them. It had its own reduction, and trademe had a better one,
...
from addresses import address_key  # noqa: E402
...
def test_there_is_only_one_address_key():
    ...
    assert defs == ["addresses.py"], defs


def test_both_callers_use_the_same_object():
    from prior_price import address_key as carry
    from trademe import address_key as portals
