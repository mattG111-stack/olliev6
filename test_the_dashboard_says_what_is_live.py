...
from app.release import publish_release, staged_summary
...
def test_the_csv_and_the_workbook_describe_the_same_thing(live):
    ...
    from app.audit_export import COLUMNS
    from app.routers.properties import export_for_sale_csv
...
def test_the_csv_says_which_rows_a_customer_cannot_see(live):
    ...
    from app.audit_export import COLUMNS, _visible_reason
