...
from ingest import canonical_region, region_is_unreadable, region_matches
from preflight_file import check, verdict
...
def test_checking_a_file_writes_nothing(db_session):
    ...
    from models import ImportBatch, IngestJob, PropertyForSale
