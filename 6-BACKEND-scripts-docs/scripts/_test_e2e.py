...
# The REPOSITORY ROOT, not this file's own directory. It used to be both — this
# script lived at the root — and after the move that line would have put
# scripts/ on the path and left `import app` failing.
