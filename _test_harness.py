...
# _step_effect: needs >=3 sales at two adjacent levels
from app.routers.properties import _step_effect, _median
pairs = [(3, 900_000)] * 4 + [(4, 1_150_000)] * 4   # +1 bed = +250k
eff = _step_effect(pairs)
check("_step_effect measures +1 level delta", eff == 250_000, f"got {eff}")
check("_step_effect None with too few sales", _step_effect([(3, 900_000), (4, 1_150_000)]) is None)
