...
ESTIMATE_COLUMNS: dict[str, tuple[str, str, str, str | None]] = {
    ...
    # OneRoof and Hougarden publish the same AVM, and the feed's own figure has
    # always been stored here. Filled only when the feed did not carry one.
    "oneroof":     ("third_party_valuation",   "third_party_valuation_low", "third_party_valuation_high", None),
