...
from models import ImportBatch, PropertyForSale, User, UserRole, UserStatus
from routers.properties import _PREVIEW, _active_batch, preview_mode
...
def _probe(db, *, preview=None, token=None):
    ...
    from routers.properties import _PREVIEW, preview_mode
...
def test_every_reader_goes_through_the_one_function(db_session):
    ...
    src = open("routers/properties.py").read()
...
def test_the_switch_is_on_the_router_so_no_endpoint_can_forget(db_session):
    from routers.properties import router
