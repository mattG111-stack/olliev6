...
from ml.train import MIN_TRAIN_ROWS, Model, fit
from models import TrainedModel, User
...
def test_the_pricing_pipeline_accepts_a_model():
    ...
    from pricing.pipeline import run
...
def test_the_model_cannot_move_a_valuation_more_than_the_bound():
    from pricing.comps import SoldDataset
    from pricing.pipeline import ML_MAX_SHIFT, run as run_pipeline
...
def test_the_diagnostic_carries_the_models_raw_opinion(db_session):
    ...
    """
    from ml.diagnostic import COLUMNS
...
def test_the_diagnostic_is_empty_rather_than_broken_with_no_batch(db_session):
    from ml.diagnostic import summary, to_csv
