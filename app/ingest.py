...
_SALE_METHOD = {
    ...
    "negotiable from": "negotiation", "enquiries over": "negotiation",
    "offers over": "negotiation", "buyer enquiry over": "negotiation",
    "buyer budget over": "negotiation", "poa": "negotiation",
    "price on application": "negotiation", "expressions of interest": "negotiation",
    "eoi": "negotiation",
}
...
def _detect_listing_type(price_display: str | None, price_numeric,
    ...
    """
    stated = _SALE_METHOD.get((str(sale_method).strip().lower()
                               if sale_method else ""))
    if stated:
        return stated
