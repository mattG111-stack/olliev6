...
from app.arcgis import classify, find_layers
...
def test_a_capped_layer_is_reported_as_partial(db_session, monkeypatch):
    ...
    monkeypatch.setattr("app.arcgis.fetch_near",
