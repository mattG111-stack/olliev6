...
def reset_users(db):
    ...
    Foreign keys are enforced now (see db.py), as they always were in
...
from ingest import _detect_listing_type as _lt
from pricing.glm import predict as _predict
...
from release import _hold_reason as _hr
...
from pricing.pipeline import run as _run
from pricing.comps import SoldDataset as _SD
...
from security import hash_password as _hp, _normalise_emails, ensure_seed_admin
...
from routers.properties import _bed_band, _bed_label, MIN_BED_MONTH_SALES
...
from assistant import keys as _keys, providers as _providers
from models import LLM_API_KEY as _K, LLM_DAILY_LIMIT as _L, LLM_PROVIDER as _P
...
from assistant.agent import ask as _ask, AssistantUnavailable as _AU
_seen = {}
...
from version import VERSION as _V, BUILT_AT as _BA
...
from pricing.subdivision import compute as _sub
...
from security import hashing_selftest as _hs, PasswordHashingUnavailable as _PHU
...
_db.add(M.User(email="  Spaced@Example.com  ", password_hash=_hp("secret123"),
               role="admin", status="approved"))
_db.commit()
from security import find_user_by_email as _fube
...
from routers import bugs as _bugsmod
...
from db import engine as _eng2
...
from data_probe import LAYERS as _LAYERS, MODEL_INPUTS as _MI    # noqa: E402
